...
func display_ghost(result):
	...
	var center = Vector3(-4, 0, 3)#tile_indicator.find_child("CollisionShape3D").global_transform.origin
	last_tile_position = Vector3(tile_x + 0.5, tile_y, tile_z + 0.5) + center
